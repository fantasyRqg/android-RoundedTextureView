...
public class RoundedTextureView extends GLTextureView {
    ...
    public RoundedTextureView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public RoundedTextureView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
